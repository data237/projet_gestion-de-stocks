...
export class Cltfrs {
  ...
  enregistrerClient(clientRequestDto: ClientRequestDto): Observable<ClientResponseDto>{
    // @ts-ignore
    clientRequestDto.entrepriseId = <number>this.userService.getConnectedUser().user.roles[0].entrepriseId
  ...
  enregistrerFournisseur(fournisseurRequestDto: FournisseurRequestDto): Observable<FournisseurResponseDto>{
    // @ts-ignore
    fournisseurRequestDto.entrepriseId = <number>this.userService.getConnectedUser().user?.roles[0].entrepriseId
