...
public class UtilisateurRequestDto {
    ...
    public static com.loic.gestiondestock.model.Utilisateur toEntity(UtilisateurRequestDto dto) {
        if (dto == null) return null;
        com.loic.gestiondestock.model.Utilisateur utilisateur = new com.loic.gestiondestock.model.Utilisateur();
